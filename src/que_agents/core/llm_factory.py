...
class LLMFactory:
    ...
    def get_llm(cls, agent_type: str, **kwargs):
        ...
        temperature = cls._llm_config["llm"]["temperature"].get(agent_type, provider_config.get("temperature", 0.7))
        ...
        if provider_name == "openai":
            ...
            return ChatAnthropic(
                ...
                base_url=os.getenv("ANTHROPIC_API_BASE", provider_config.get("api_base")),
                max_tokens=max_tokens,
                request_timeout=timeout
            )
            ...
            return ChatOpenAI(
                azure_endpoint=os.getenv("AZURE_OPENAI_ENDPOINT", provider_config["api_base"]),
                api_key=os.getenv("AZURE_OPENAI_API_KEY", provider_config["api_key"]),
                azure_deployment=os.getenv("AZURE_OPENAI_DEPLOYMENT_NAME", provider_config["deployment_name"]),
